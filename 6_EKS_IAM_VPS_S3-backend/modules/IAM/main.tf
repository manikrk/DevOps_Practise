...
resource "aws_iam_role" "vrp_cluster_role" {
...
resource "aws_iam_role_policy_attachment" "eks_cluster_role_policy_AmazonEKSClusterPolicy" {
  role = aws_iam_role.vrp_cluster_role.name
...
resource "aws_iam_role" "vrp_node_group_role" {
  name = var.vrp_node_group_role_name
...
resource "aws_iam_role_policy_attachment" "policy_AmazonEKSWorkerNodePolicy" {
    ...
    role        = aws_iam_role.vrp_node_group_role.name
}   
